...
range.map(this._createLabelForYAxis)));}}]);return YAxis;}(_react.Component);YAxis.propTypes={axisColor:PropTypes.any,axisLineWidth:PropTypes.number,data:PropTypes.arrayOf(PropTypes.array).isRequired,height:PropTypes.number.isRequired,placement:PropTypes.oneOf(['left','right']),verticalGridStep:PropTypes.number.isRequired,yAxisTransform:PropTypes.func};YAxis.defaultProps={placement:'left'};exports.default=YAxis;