...
return (
_react2.default.createElement(Shape,{d:path,stroke:this.props.stroke,fill:this.props.fill,strokeWidth:1,__source:{fileName:_jsxFileName,lineNumber:26}}));}}]);return Circle;}(_react.Component);Circle.propTypes={radius:PropTypes.number.isRequired,x:PropTypes.number.isRequired,y:PropTypes.number.isRequired,onPress:PropTypes.func,fill:PropTypes.string,stroke:PropTypes.string};Circle.defaultProps={onPress:function onPress(){},radius:2,fill:C.BLACK,stroke:C.BLACK};exports.default=Circle;