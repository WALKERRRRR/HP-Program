...
verticalRange.map(function(_,i){return _react2.default.createElement(_reactNative.View,{key:i,style:verticalGridStyle,__source:{fileName:_jsxFileName,lineNumber:68}});})));}()));}}]);return Grid;}(_react.Component);Grid.propTypes={showGrid:PropTypes.bool,data:PropTypes.array.isRequired,verticalGridStep:PropTypes.number.isRequired,gridLineWidth:PropTypes.number,gridColor:PropTypes.oneOfType([PropTypes.number,PropTypes.string]),hideHorizontalGridLines:PropTypes.bool,hideVerticalGridLines:PropTypes.bool,height:PropTypes.number.isRequired,width:PropTypes.number.isRequired,type:PropTypes.oneOf(['line','bar','pie']).isRequired};Grid.defaultProps={};exports.default=Grid;